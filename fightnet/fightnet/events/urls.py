...
urlpatterns = [
    ...
    path("api/mis-eventos/", views.api_mis_eventos, name="api_mis_eventos"),
    ...
    path(
        "api/my-registration/<int:pk>/",
        views.api_my_registration,
        name="api_my_registration",
    ),
    ...
    path("api/me/upload-foto/", views.api_me_upload_foto, name="api_me_upload_foto"),
]
